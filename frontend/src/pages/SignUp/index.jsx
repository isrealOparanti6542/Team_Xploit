                        ...
                        <div className="text-white mt-4 text-center">Create Account</div>
                         ...
                         <div className="text-white font-bold">
                          ...
                          <div className="flex justify-center">
                            <button className="bg-white py-1 px-4 w-full text-sm rounded-full">METAMASK</button>
                          </div>
                          <div className="flex justify-center">
                            <button className="bg-primary-dark text-white  py-1 px-4 w-full text-sm rounded-full">Sign Up</button>
                          </div>
                        </form>
                      </div>
